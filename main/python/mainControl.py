...
if True:
    ...
    BAD=Speichern.BPM_Read("Quelle1") #Aus Speicher laden.
...
cv2.imwrite("_korriegiert GOOD_NB2_NARC.png", GOOD_NB2_NARC)
cv2.imwrite("_korriegiert GOOD_NB2_NMFC.png", GOOD_NB2_NMFC)
cv2.imwrite("_korriegiert GOOD_NB2_NSRC.png", GOOD_NB2_NSRC)
cv2.imwrite("_korriegiert GOOD_NB.png", GOOD_NB)
cv2.imwrite("_korriegiert GOOD_Grad_NARC.png", GOOD_Grad_NARC)
cv2.imwrite("_korriegiert GOOD_Grad_NMFC.png", GOOD_Grad_NMFC)
cv2.imwrite("_korriegiert GOOD_Grad_NSRC.png", GOOD_Grad_NSRC)
cv2.imwrite("_korriegiert GOOD_Hybrid.png", GOOD_Hybrid)
cv2.imwrite("_korriegiert Flatfield.png", GOOD_Flatfield)
